...
var $loadname59=$loc.playSound!==undefined?$loc.playSound:Sk.misceval.loadname('playSound',$gbl);;$ret = ($loadname59.tp$call)?$loadname59.tp$call([$scope0.$const60],undefined) : Sk.misceval.applyOrSuspend($loadname59,undefined,undefined,undefined,[$scope0.$const60]);$blk=45;case 45: if ($ret && $ret.$isSuspension) { return $saveSuspension($ret,'<stdin>.py',20,8); }var $call61=$ret;
...
var $loadname110=$loc.playFreeSoundOrg!==undefined?$loc.playFreeSoundOrg:Sk.misceval.loadname('playFreeSoundOrg',$gbl);;$ret = ($loadname110.tp$call)?$loadname110.tp$call([$scope0.$const111],undefined) : Sk.misceval.applyOrSuspend($loadname110,undefined,undefined,undefined,[$scope0.$const111]);$blk=83;case 83: if ($ret && $ret.$isSuspension) { return $saveSuspension($ret,'<stdin>.py',33,8); }var $call112=$ret;
...
var $loadname67=$loc.playSound!==undefined?$loc.playSound:Sk.misceval.loadname('playSound',$gbl);;$ret = ($loadname67.tp$call)?$loadname67.tp$call([$scope0.$const68],undefined) : Sk.misceval.applyOrSuspend($loadname67,undefined,undefined,undefined,[$scope0.$const68]);$blk=52;case 52: if ($ret && $ret.$isSuspension) { return $saveSuspension($ret,'<stdin>.py',22,8); }var $call69=$ret;
...
var $loadname117=$loc.playFreeSoundOrg!==undefined?$loc.playFreeSoundOrg:Sk.misceval.loadname('playFreeSoundOrg',$gbl);;$ret = ($loadname117.tp$call)?$loadname117.tp$call([$scope0.$const118],undefined) : Sk.misceval.applyOrSuspend($loadname117,undefined,undefined,undefined,[$scope0.$const118]);$blk=90;case 90: if ($ret && $ret.$isSuspension) { return $saveSuspension($ret,'<stdin>.py',35,8); }var $call119=$ret;
