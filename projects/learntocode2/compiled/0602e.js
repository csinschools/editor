...
var $loadname95=$loc.print!==undefined?$loc.print:Sk.misceval.loadname('print',$gbl);;$ret = ($loadname95.tp$call)?$loadname95.tp$call([$scope0.$const96],undefined) : Sk.misceval.applyOrSuspend($loadname95,undefined,undefined,undefined,[$scope0.$const96]);$blk=92;case 92: if ($ret && $ret.$isSuspension) { return $saveSuspension($ret,'<stdin>.py',40,0); }var $call97=$ret;

$currLineNo = 40;
$currColNo = 0;

return $loc;throw new Sk.builtin.SystemError('internal error: unterminated block');case 82: $blk=76; continue;case 87: 

$currLineNo = 39;
$currColNo = 0;

$blk=88; continue;}}catch(err){ if (!(err instanceof Sk.builtin.BaseException)) { err = new Sk.builtin.ExternalError(err); } err.traceback.push({lineno: $currLineNo, colno: $currColNo, filename: '<stdin>.py'}); if ($exc.length>0) { $err = err; $blk=$exc.pop(); continue; } else { throw err; }} } });$scope0.$const2 = new Sk.builtin.str("shipping_free");$scope0.$const3 = new Sk.builtin.str("item_balloon");$scope0.$const7 = new Sk.builtin.str("Your item:");$scope0.$const14 = new Sk.builtin.str("\ud83c\udf88");$scope0.$const18 = new Sk.builtin.str("item_popper");$scope0.$const22 = new Sk.builtin.str("\ud83c\udf89");$scope0.$const25 = new Sk.builtin.str("Shipping mode:");$scope0.$const33 = new Sk.builtin.str('yellow');$scope0.$const35 = new Sk.builtin.str("Free!");$scope0.$const37 = new Sk.builtin.str('reset');$scope0.$const39 = new Sk.builtin.str("");$scope0.$const43 = new Sk.builtin.str("shipping_standard");$scope0.$const47 = new Sk.builtin.str("$5");$scope0.$const50 = new Sk.builtin.str("==== Menu ====");$scope0.$const53 = new Sk.builtin.str("[1] Change item to balloon");$scope0.$const56 = new Sk.builtin.str("[2] Change item to firecracker");$scope0.$const59 = new Sk.builtin.str("[3] Use free shipping");$scope0.$const62 = new Sk.builtin.str("[4] Use standard shipping");$scope0.$const65 = new Sk.builtin.str("[5] Checkout");$scope0.$const68 = new Sk.builtin.str("Enter your choice:");$scope0.$const72 = new Sk.builtin.str("1");$scope0.$const77 = new Sk.builtin.str("2");$scope0.$const82 = new Sk.builtin.str("3");$scope0.$const87 = new Sk.builtin.str("4");$scope0.$const92 = new Sk.builtin.str("5");$scope0.$const96 = new Sk.builtin.str("Thanks for visiting our store!");
return $scope0;}();
$compiledmod;